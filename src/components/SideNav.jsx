...
function SideNav() {
  ...
  return (
    <aside className="fixed bottom-0 border-t p-4 w-full z-10 bg-gray-800 border-slate-400 sm:border-r sm:border-t-0 sm:gap-10 flex flex-row font-robotoFlex rounded-md lg:mt-2 justify-around sm:flex-col sm:static sm:bottom-none sm:w-max sm:justify-start lg:items-start lg:w-64 lg:h-max lg:ml-1 lg:border-none ">
